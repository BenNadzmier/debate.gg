...
### Step 2: Create a New Project from GitHub Repo
...
4. **If prompted, click "Configure GitHub App"**:
   - Select your GitHub account
   - Choose "All repositories" or select the specific repo
   - Click "Install & Authorize"

5. **Select your debate.gg repository** from the list

6. **Click "Deploy Now"**

7. Railway will automatically detect it's a Python app and start building
...
4. **Click "New Variable"** and add each of these:
   ...
   | `HOST_ROLE_ID` | Your host role ID (optional) | From Step 4.6 of Discord setup (or leave empty) |

5. **After adding all variables**, the bot will automatically redeploy
